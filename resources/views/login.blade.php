        ...
        <form>
          ...
          <div class="flex" style="justify-content: center; margin-left: 4rem; margin-top: 2.5rem">
            <div class="flex-initial" style="padding-left: 1.75rem; padding-right: 1.75rem">
              <p style="font-size: 1.875rem; line-height: 2.25rem; color: rgba(31, 41, 55, 1); font-weight: 700; letter-spacing: 0.025em;">
                Welcome Back
              </p>
              ...
              <div class="flex" style="margin-top: 2.5rem;">
                ...
                <div class="flex-1" style="margin-left: 2rem; margin-top: 8px; align-items: center">
                  <a
